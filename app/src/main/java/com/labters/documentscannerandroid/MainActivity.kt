...
class MainActivity : AppCompatActivity() {
    ...
    fun setView() {
        btnPick.setOnClickListener(View.OnClickListener {
            ...
            builder.setMessage("Either From Camera or From Gallery")
...
//                    var photoFile: File? = null
                    var file = File("/textfile.jpg")


                    try {
                        file=createImageFile()
//                        photoFile = createImageFile()
                        Log.i("asdfg", "setView: "+file)
                        Log.i("asdfg", "setView: ")
...
//        val imageFileName = "JPEG_" + timeStamp + "_"
        ...
        Log.d("imagepath", "createImageFile: "+mCurrentPhotoPath)
        return image
    }
