...
public class ImageCropActivity extends DocumentScanActivity {
    ...
    private String saveToInternalStorage(Bitmap bitmapImage) {
        ...
        try {
            ...
            Log.d("123", "saveToInternalStorage: ");
            Log.d("123", "saveToInternalStorage: "+fos);
        } catch (Exception e) {
            e.printStackTrace();
            Log.d("123", "saveToInternalStorage: ");
            Log.d("123", "saveToInternalStorage: "+e);
        } finally {
            try {
                fos.close();
                Log.d("1234", "saveToInternalStorage: ");
            } catch (Exception e) {
                Log.d("1234", "saveToInternalStorage: ");
                Log.d("1234", "saveToInternalStorage: "+e);
                e.printStackTrace();
            }
        }
